        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 10, display: "flex", gap: 10 }}>
              ...
              <a
                href={`/api/qr?text=${encodeURIComponent(dl)}`}
                target="_blank"
                rel="noreferrer"
                style={{
                  padding: "8px 12px",
              ...
              <a
                href={`/api/qr.svg?text=${encodeURIComponent(dl)}`}
                target="_blank"
                rel="noreferrer"
                style={{
                  padding: "8px 12px",
